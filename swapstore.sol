...
//
// token 0 is ethereum and token 1 is daoCoin, keep it simple with 1-1 ratio
contract SwapPool is ERC20 {
  ...
  uint public constant INITIAL_SUPPLY = 1;
   ...
   * 2. Emit Dow tokens
   * 3. Update reserves
   * uses idea that reserves will always be proportional to token number unless changed
   * will need to come up with different mechanism here I guess
   */
